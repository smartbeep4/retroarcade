...
describe('Pong', () => {
  ...
  describe('config', () => {
    ...
    it('has correct description', () => {
      expect(Pong.config.description).toBe('Classic paddle game. First to 11 wins!')
    })
  ...
  describe('initialization', () => {
    ...
    it('initializes paddle positions correctly', () => {
      ...
      expect(game.paddle2.x).toBe(canvas.width - game.paddleOffset - game.paddleWidth)
  ...
  describe('paddle movement', () => {
    ...
    it('clamps paddle2 to screen bounds', () => {
      ...
      game.update(16)
      expect(game.paddle2.y).toBeLessThanOrEqual(canvas.height - game.paddleHeight)
    })
  })
  ...
  describe('AI behavior', () => {
    ...
    it('AI does not move when ball is centered on paddle', () => {
      ...
      expect(Math.abs(game.paddle2.y - initialY)).toBeLessThanOrEqual(game.paddleSpeed)
    })
