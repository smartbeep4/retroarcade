...
console.log('   Settings before save:', JSON.stringify(beforeSettings, null, 2))
...
console.log('   Settings after reload:', JSON.stringify(afterSettings, null, 2))
console.log('   Settings match:', JSON.stringify(beforeSettings) === JSON.stringify(afterSettings))
