...
describe('AudioManager', () => {
  ...
  describe('mute functionality', () => {
    ...
    it('saves mute state to localStorage', () => {
      ...
      AudioManager.unmute()
      const savedAfterUnmute = JSON.parse(localStorage.getItem('retroarcade-audio'))
  ...
  describe('music playback', () => {
    ...
    it('resumes paused music', async () => {
      ...
      expect(mockAudioContext.createBufferSource.mock.calls.length).toBeGreaterThan(createCalls)
    })
