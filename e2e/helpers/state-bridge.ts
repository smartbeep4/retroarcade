...
export class StateBridge {
   ...
   */
  async waitForShellState(targetState: ShellState['state'], timeout: number = 5000): Promise<void> {
    await expect(async () => {
   ...
   */
  async waitForGameState(targetState: GameState['state'], timeout: number = 5000): Promise<void> {
    await expect(async () => {
   ...
   */
  async waitForGameLoaded(gameId: string, timeout: number = 5000): Promise<void> {
    await expect(async () => {
   ...
   */
  async waitForScoreChange(initialScore: number, timeout: number = 5000): Promise<number> {
   ...
   */
  async waitForScoreAtLeast(targetScore: number, timeout: number = 10000): Promise<void> {
    await expect(async () => {
   ...
   */
  async waitForLifeLost(initialLives: number, timeout: number = 5000): Promise<number> {
